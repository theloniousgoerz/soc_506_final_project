...
I employ the GSSR package to look at the 2018 sample of respondants, and use the question "sexeduc" to test this hypothesis. In the table below, I summarize the variables that I pull from. 
...
Summary statistics show that the sample is majority non-Hispanic White with at least a high school education. Overwhelmingly, most favor sex education as well and are at an avrage age of 44. Further summaries in the appendix show that the majority also make a respodant income of more than $25,000 per year. 

### Methods

I fit two logistic regression models that aim at classifying one's approval or dissaproval about sex education in schools. The models were then compared together to see whether trends in the base model were robust to covariates, to test the relationship between income and approval of sex education. 
...
For those that are in the 25,000 dollar a year or more category, thre is a significant `r summary(glm_base)$coefficients[6]` increase in the log odds of approving of sex education in public schools. All of the other categories are not significant. This might be reflective of the fact that the income categories as a whole are not very useful since we know that in the late 2010s, there are many respondants who make more than 25,000 so this is potentially obscuring a lot of variation. 

Adding in the other predictors, controlling for race, gender, education,, and year born, All are insignificant except for cohort amnd those being in the income category of 25,000 or more  For a one year increase in the year born, there is a `r summary(glm_full)$coefficients[21]` increase in the log-odds of favoring sex education in public schools holding all else constant, which is significant
. 
...
Below I present a table of supplemental descriptive statistics for the sample. Most people make 25,000 dollars or more, indicating that this income measure is potentially problematic because we obscure a lot of our data that may be contained in the higher areas of the income distribution. 
